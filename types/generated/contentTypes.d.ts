...
export interface ApiCustomerOrderCustomerOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customerData: Attribute.JSON;
    orderStatus: Attribute.Enumeration<
      ['not-paid', 'successful', 'failed', 'cash-on-delivery']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'not-paid'>;
    stripePaymentIntentId: Attribute.String & Attribute.Unique;
    isStripeVerified: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiInvoiceNumberInvoiceNumber extends Schema.CollectionType {
  collectionName: 'invoice_numbers';
  info: {
    singularName: 'invoice-number';
    pluralName: 'invoice-numbers';
  ...
  attributes: {
    invoiceNumber: Attribute.Integer & Attribute.DefaultTo<1>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::invoice-number.invoice-number',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productAttributes: Attribute.Component<
